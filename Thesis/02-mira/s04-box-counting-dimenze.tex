...
\begin{theorem}\label{thm:bc-dimenze-lebesgueova-mira}
    Nechť $F\in\mathcal{L}(\R^n)$ je uzavřená a omezená. Pak platí: 
    \begin{enumerate}[label=(\roman*)]
...
\begin{proof}
    ...
    Mějme $F\in\mathcal{L}(\R^n)$ omezenou a uzavřenou. Označme $v_n$ objem jednotkové koule $K_1(x)$\footnote{Objem koule v~$\R^n$ lze vyjádřit vztahem
...
\begin{lemma}\label{lem:lipschitzovska-zobrazeni-a-bijekce}
    Nechť $(X,\varrho_1),(Y,\varrho_2)$ jsou metrické prostory a zobrazení $\mapping{f}{X}{Y}$ je bilipschitzovské. Pak $\mapping{f^\prime}{X}{f(X)}$ je bijekce.
\end{lemma}
\begin{proof}
    ...
    \[K_1\varrho_1(x,y)\leqslant\varrho_2(f^\prime(x),f^\prime(y))\leqslant K_2\varrho_1(x,y),\;x,y\in X.\]
    ...
    \[0<K_1\varrho_1(x,y)\leqslant\varrho_2(f^\prime(x),f^\prime(y))=0,\]
    což je spor.
\end{proof}
...
\begin{proof}
    ...
    \begin{enumerate}[label=\textit{(\roman*)}]
        ...
        \[K_1\varrho_n(x,y)=K_1\varrho_n(g^{-1}(u),g^{-1}(v))\leqslant\varrho_m(g(g^{-1}(u)),g(g^{-1}(v)))=\varrho_m(u,v),\]
        neboli
        \[\varrho_n(g^{-1}(u),g^{-1}(v))\leqslant\dfrac{1}{K_1}\varrho_m(u,v),\]
