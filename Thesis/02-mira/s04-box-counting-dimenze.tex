...
\begin{example}[Cantorovo diskontinuum]\label{ex:cantorovo-diskontinuum}
    Již jsme měli možnost se přesvědčit,~že Cantorovo diskontinuum,~označme $C$,~má box-counting dimenzi $\ln{2}/\ln{3}$. Zkusme nyní výpočet zopakovat,~avšak vzlášť vypočítáme $\lowerdimB{C}$ a $\upperdimB{C}$ podíváme se,~zda se shodují.
...
\todo{Přidat i vlastnosti dimenze vůči Lipschitzovským zobrazením?}