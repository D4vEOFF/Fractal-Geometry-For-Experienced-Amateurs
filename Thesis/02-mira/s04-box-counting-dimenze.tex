...
\begin{itemize}
    ...
    \[\lambda_3(F_\delta)\leqslant n\cdot\dfrac{4}{3}\pi\delta^3.\]
    ...
    \[\lambda_3(u_\delta)=\dfrac{4}{3}\pi \delta^3+\pi\delta^2\ell.\]
    Pokud však uvážíme $\delta$ dostatečně malé,~lze první člen zanedbat a psát
    \[\lambda_3(u_\delta)\approx\pi\ell\delta^2.\]
    \item V~případě neprázdného kvádru
    \[I=\set{(x,y,0)\mid x\in\langle a_1,b_1\rangle\,,\,y\in\langle a_2,b_2\rangle}\]
    je
    \begin{align*}
        \lambda_3(I_\delta)&=2(b_1-a_1)(a_2-b_2)\delta+2(b_1-a_1)\pi\delta^2+2(b_2-a_2)\pi\delta^2+\dfrac{4}{3}\pi\delta^3\\
...
\begin{table}[h]
    \centering
    \begin{tabular}{r|c}
    Útvar $F$                               & $\lambda_3(F_\delta)$       \\\hline
    Konečná množina $\set{x_1,\ldots,x_n}$ & $\frac{4n}{3}\pi\delta^3$   \\
    Úsečka $u$                             & $\pi\ell\delta^2$           \\
    Kvádr $I$                              & $2(b_1-a_1)(a_2-b_2)\delta$ \\
    Koule $B_\delta(x)$                    & $\frac{4}{3}\pi r^3$      
    \end{tabular}
    \caption{Odhady $\lambda_3$ pro vybrané útvary}
