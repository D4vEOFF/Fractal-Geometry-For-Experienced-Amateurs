...
\end{figure}
Při zjemňování čtvercové sítě konvergují součty $S$ a $S+S^\prime$ k limitám, které po řadě nazýváme \emph{vnitřní} a \emph{vnější Jordanova-Peanova míra}\index{Jordanova-Peanova míra}\index{Jordanova-Peanova míra!vnitřní Jordanova-Peanova míra}\index{Jordanova-Peanova míra!vnější Jordanova-Peanova míra}. Tato úvaha předložila základní předpoklady právě pro vznik teorie míry. \cite{Sarmanova1996}
...
\begin{definition}[Vnější Lebesgueova míra]\label{def:vnejsi-lebegueova-mira}
    Nechť $A\subseteq\R^n$. Pak vnější $n$-rozměr\-nou Lebesgueovou mírou\index{Lebesgueova míra!vnější $n$-rozměrná Lebesgueova míra} $A$ je
