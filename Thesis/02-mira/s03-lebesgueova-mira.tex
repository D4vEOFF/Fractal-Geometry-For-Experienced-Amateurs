...
\begin{theorem}\label{thm:prostor-s-Lebesgueovou-mirou}
    ...
    \end{enumerate}
\end{theorem}
Čtenář doufám promine, že formální důkaz v případě tohoto tvrzení zcela vynecháme, nicméně "zvídavec" jej může nalézt např. v knize \citep[str. 347]{Royden2010}, kde jsou příslušné formální záležitosti rozepsány.