...
%% Nastavení indexu
\makeindex[columns=2,title=Rejstřík]
...
\usepackage{mathrsfs}
\usepackage{tikz}
\usetikzlibrary{arrows, trees,positioning, shapes.callouts, arrows.meta, shapes.geometric, backgrounds, matrix, calc}

\usepackage[linesnumbered,ruled,vlined,czech]{algorithm2e}                % Pseudokód algoritmů
