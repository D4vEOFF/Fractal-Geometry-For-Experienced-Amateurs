...
\lstdefinestyle{python}{
  ...
  identifierstyle=\color{black},% proměnné zůstanou černé
  morekeywords=[2]{int,float,str,bool,list,dict,set,tuple},% datové typy
  keywordstyle=[2]\color{codegreen},% zeleně jen typy
  numbers=left,%
  ...
  breaklines=true,%
  backgroundcolor=\color{lightgray}% světle šedé pozadí
}
