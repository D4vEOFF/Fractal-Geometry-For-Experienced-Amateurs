...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{bracketed-ol-1-iter4.pdf}
    \begin{center}
        $n=4$
    \end{center}
...
\begin{figure}
    ...
    \includegraphics[width=0.4\textwidth]{lakes-and-islands-iter2.pdf}\qquad
    \includegraphics[width=0.4\textwidth]{lakes-and-islands-iter3.pdf}
    \begin{align*}
        \omega&=F+F+F+F\\
