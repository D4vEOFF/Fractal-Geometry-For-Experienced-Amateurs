...
\begin{definition}[Hausdorffova metrika]\label{def:hausdorffova-metrika}
    Hausdorffovou metrikou\index{Hausdorffův metrický prostor!Hausdorffova metrika}\index{Hausdorffův metrický prostor}\index{metrický prostor!Hausdorffův} (vzdálenost) nazýváme takové zobrazení $\mapping{\hausdorffmetric}{\powset{X}^2}{\langle0,\infty\rangle}$, kde pro každé $A,B\in\powset{X}$ platí
