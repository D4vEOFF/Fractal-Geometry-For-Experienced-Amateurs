...
\end{align*}
Idea aproximace pomocí ``zjemňování'' zde skutečně funguje a délka ve standardním pojetí tak dává smysl, jak bychom mohli očekávat. Křivka, kterou tvoří pobřeží, má však oproti kružnici jiný geometrický charakter. Délka pobřeží $\infty$, k níž Mandelbrot došel, tak dává smysl \emph{z geometrického pohledu}, avšak není moc užitečný.