...
\begin{theorem}[Součet geomerické řady]\label{thm:soucet_geometricke_rady}
    ...
    \begin{equation*}
        \sum_{k=1}^{n}{g_k}=g_1\cdot\dfrac{1-q^n}{1-q}.
    \end{equation*}
\end{theorem}
...
\begin{equation*}
    O_n=3+\sum_{k=1}^n{\left(\dfrac{3}{2}\right)^k}=3+\dfrac{3}{2}\cdot\dfrac{\left(\dfrac{3}{2}\right)^n-1}{\dfrac{3}{2}-1}=3+3\cdot\left(\left(\dfrac{3}{2}\right)^n-1\right)=3\cdot\left(\dfrac{3}{2}\right)^n.
\end{equation*}
