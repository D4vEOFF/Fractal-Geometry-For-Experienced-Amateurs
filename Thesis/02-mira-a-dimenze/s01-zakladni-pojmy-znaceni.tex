...
Poměrně důležitým pojmem v~teorii metrických prostorů jsou tzv. kompaktní množiny. S~tím se pojí následující termíny (viz definice~\ref{def:delta-pokryti-zjemneni}).
\begin{definition}[Pokrytí,~$\delta$-pokrytí a zjemnění]\label{def:delta-pokryti-zjemneni}
    ...
    \begin{itemize}
        ...
        Navíc o~pokrytí $\mathcal{U}$ říkáme,~že je \emph{otevřené}\index{pokrytí!otevřené},~pokud pro každé $i\in\N$ je množina $U_i$ otevřená.
        ...
        \item Pokud navíc pro každou $G\in\mathcal{G}$ existuje množina $U\in\mathcal{U}$,~taková,~že $G\subseteq U$,~pak $\mathcal{G}$ nazýváme \emph{zjemněním}\index{zjemnění} pokrytí $\mathcal{U}$. 
    \end{itemize}
\end{definition}
