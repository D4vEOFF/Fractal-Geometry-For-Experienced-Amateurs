...
\begin{itemize}
    ...
    \item \emph{box-counting dimenzí},\index{box-counting dimenze}\footnote{Též ji lze nalézt pod~názvem \emph{Minkowského dimenze}\index{dimenze!Minkowského} nebo \emph{Minkowského-Bouligandova dimenze}\index{dimenze!Minkowského-Bouligandova}. Je pojmenována po polském matematikovi \name{Hermannovi Minkowském} (1864--1909) a~francouzském matematikovi \name{Georgesovi Bouligandovi} (1889--1979).}
