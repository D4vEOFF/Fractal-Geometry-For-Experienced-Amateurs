...
\end{figure}
Při zjemňování čtvercové sítě konvergují součty $S$ a $S+S^\prime$ k~limitám,~které po řadě nazýváme \emph{vnitřní} a \emph{vnější Jordanova-Peanova míra}\index{Jordanova-Peanova míra}\index{míra!Jordanova-Peanova}. Tato úvaha předložila základní předpoklady právě pro vznik teorie míry. \cite{Sarmanova1996}
