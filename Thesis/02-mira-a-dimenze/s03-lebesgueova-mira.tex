...
\begin{proof}
    ...
    \begin{itemize}
        ...
        kde $x_j$ je střed $j$-tého intervalu kvádru $I_i$ a $r_j$ jeho poloměr, tzn. $r_j=(b_j-a_j)/2$. Protože však $I$ je uzavřená a~omezená množina,~je podle věty \ref{thm:heine-borel} kompaktní,~tedy z~otevřeného pokrytí $\interior{J_1},\interior{J_2},\ldots$ lze vybrat konečné podpokrytí. Existuje tedy $m\in\N$,~takové,~že
